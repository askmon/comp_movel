...
public class ListarNovosTest extends ActivityInstrumentationTestCase2<ListarNovos> {
	...
	public void setUp() throws Exception {
		...
		incidentList = Arrays.asList(incidente, incidente, incidente, incidente, incidente);
		...
		incidentTexts[0] = (TextView) listarNovosActivity.findViewById(R.id.ocorrencia1);
		incidentTexts[1] = (TextView) listarNovosActivity.findViewById(R.id.ocorrencia2);
		incidentTexts[2] = (TextView) listarNovosActivity.findViewById(R.id.ocorrencia3);
		incidentTexts[3] = (TextView) listarNovosActivity.findViewById(R.id.ocorrencia4);
		incidentTexts[4] = (TextView) listarNovosActivity.findViewById(R.id.ocorrencia5);
		incidentImages[0] = (ImageView) listarNovosActivity.findViewById(R.id.ivImage1);
		incidentImages[1] = (ImageView) listarNovosActivity.findViewById(R.id.ivImage2);
		incidentImages[2] = (ImageView) listarNovosActivity.findViewById(R.id.ivImage3);
		incidentImages[3] = (ImageView) listarNovosActivity.findViewById(R.id.ivImage4);
		incidentImages[4] = (ImageView) listarNovosActivity.findViewById(R.id.ivImage5);
	}
